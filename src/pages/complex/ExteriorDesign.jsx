...
const extData1 = [
  {
    ...
    img: 'ext-p1.jpg',
    sub: 'FLOWING WAVE',
    title: <>유연하게 흐르는 <strong>건축의 리듬</strong></>,
    desc: <>
  ...
  },
  {
    ...
    img: 'ext-p2.jpg',
    sub: 'CRUISE PRESTIGE',
    title: <>도심 위를 <strong>항해하는 품격</strong></>,
    desc: <>
  ...
  },
  {
    id: 3,
    img: 'ext-p3.jpg',
    sub: 'SHIMMERING MELODY',
    title: <>별빛처럼 반짝이는 <strong>빛의 선율</strong></>,
    desc: <>
  ...
  },
  {
    ...
    img: 'ext-p4.jpg',
    sub: 'REFLECTIVE FLOW',
    title: <>도시의 풍경을 담는 <strong>빛의 프레임</strong></>,
    desc: <>
            ...
            <div className="sub-contents">
              ...
              <div className="exterior-sect1">
                <div className="static">
                  ...
                  <div className="sect1">
                    {extData1.map(item => (
                      <div className={`extbock ${item.isEven ? 'even' : ''}`} key={item.id}>
                        {item.isEven ? (
                          <>
                            <div className="desc n-motion n-left">
                              <p className="tx">{item.sub}</p>
                              <h4>{item.title}</h4>
